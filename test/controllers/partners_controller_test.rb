...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { business: @partner.business, email: @partner.email, name: @partner.name, rent: @partner.rent, telephone: @partner.telephone }
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: { business: @partner.business, email: @partner.email, name: @partner.name, rent: @partner.rent, telephone: @partner.telephone }
    assert_redirected_to partner_path(assigns(:partner))
  end
